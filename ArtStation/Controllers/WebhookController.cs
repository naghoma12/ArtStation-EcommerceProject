...
[HttpPost("webhook/paymob")]
    ...
    //    _logger.LogInformation("📥 Raw JSON received: " + rawJson);
    ...
    //    //    // ✅ تحقق من نجاح المعاملة والتأكيد
    //    //    if (transaction.Success && transaction.IsCapture && !transaction.IsRefunded)
    //    //    {
    //    //        // تحقق من عدم تكرار نفس المعاملة
    //    //        var existing = await _unitOfWork.Repository<PaymentTransaction>()
    //    //            .FindAsync(t => t.TransactionId == transactionId);
    ...
    //    //        // وسيلة الدفع إن وُجدت (card, wallet...)
    //    //        var paymentMethod = transaction.SourceData?.Type ?? "paymob";
    //    //        var paymentProvider = transaction.SourceData?.SubType ?? "";
    ...
    //    //        {
    //    //            order.PaymentStatus = PaymentStatus.Paid;
    //    //            order.Status = OrderStatus.Placed; // غيّرها حسب نظامك
    ...
    //    //        else
    //    //        {
    //    //            _logger.LogWarning($"⚠️ Order not found for PaymobOrderId: {paymobOrderId}");
    //    //        }
    //    //    }
    //    //    else
    //    //    {
    ...
    //    //    return Ok(); // مهم جداً أن ترجع Ok حتى لا تعيد Paymob الإرسال
    //    //}
    //    //catch (Exception ex)
    //    //{
    //    //    _logger.LogError(ex, "🔥 Error while handling Paymob callback");
    //    //    return BadRequest("redfgh");
    //    //}
    //}
